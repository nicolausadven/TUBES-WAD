...
<nav class="navbar navbar-expand-lg  fixed-top" style="background-color: #FCD484">
    <div class="container">
        ...
        <a> <img src="{{asset('elkatp/syart.png')}}" height="50px" class="ml-3 d-inline-block align-top" alt=""></a>
        <a> <img src="{{asset('elkatp/bantuan.png')}}" height="50px" class="d-inline-block align-top" alt=""></a>
        </span>
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" id="navDropDownLink" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="{{asset('elkatp/profile.png')}}" height="50px" class="ml-3 d-inline-block align-top"
                             alt="">
                    </a>
