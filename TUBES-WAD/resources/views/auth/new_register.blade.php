                    ...
                    <div class="card-body">
                        <form action="{{ url('/regis-user') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="">NIK</label>
                                <input type="text" class="form-control" value="{{ old('nik') }}" name="nik" id="" aria-describedby="helpId" placeholder="Nomor Induk Kependudukan">
                                <small id="helpId" class="form-text text-muted">NIK</small>
                            </div>

                            <div class="form-group">
                                <label for="">Nomor KK</label>
                                <input type="text" class="form-control" value="{{ old('no_kk') }}" name="no_kk" id="" aria-describedby="helpId" placeholder="Nomor Kartu Keluarga">
                                <small id="helpId" class="form-text text-muted">Nomor KK</small>
                            </div>

                            <div class="form-group">
                                <label for="">Nomor HP</label>
                                <input type="text" class="form-control" value="{{ old('contact') }}" name="contact" id="" aria-describedby="helpId" placeholder="Nomor Kartu Keluarga">
                                <small id="helpId" class="form-text text-muted">Kontak</small>
                            </div>

                            <div class="form-group">
                                <label for="">Password</label>
                                <input type="password" class="form-control" name="password1" id="" aria-describedby="helpId" placeholder="Password">
                                <small id="helpId" class="form-text text-muted">Password</small>
                            </div>

                            <div class="form-group">
                                <label for="">Ulangi Password</label>
                                <input type="password" class="form-control" name="password2" id="" aria-describedby="helpId" placeholder="Ulangi Password">
                                <small id="helpId" class="form-text text-muted">Ulangi Password</small>
                            </div>

                            <button type="submit" class="btn btn-primary">Registrasi</button>

                            <p class="text-center">Sudah Punya Akun ? Login <a href="{{ url('/login-pengguna') }}">Disini </a></p>
